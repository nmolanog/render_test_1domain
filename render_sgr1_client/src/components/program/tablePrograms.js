    ...
    return (
        <div >
            ...
            <DataTable value={props.programs} stripedRows paginator rows={5} rowsPerPageOptions={[5, 10, 25, 50]} >
                ...
                <Column header="" body={(rowData) => <EditProgram data={rowData} clearsearch={props.clearsearch} />} />
                <Column header="" body={(rowData) => <DeleteProgram data={rowData} clearsearch={props.clearsearch} />} />
            </DataTable>
        </div>
    );
}
